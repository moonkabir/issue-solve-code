...
<ul class="shop_table shop_table_responsive cart" cellspacing="0">
				...
				<li class="<?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
					...
					<div class="product_text">
						...
						<div class="product_text_right">
	                        ...
	                        <?php echo apply_filters( 'woocommerce_widget_cart_item_quantity', '<div class="price">&times; ' . sprintf( '%s', $product_price ) . '</div>', $cart_item, $cart_item_key ); ?>
                        </div>
                    </div>
