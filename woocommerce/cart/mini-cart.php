...
<div class="widget_shopping_cart_calc">
    ...
    <p class="buttons">
		<a href="<?php echo esc_url( wc_get_cart_url() ); ?>" class="button wc-forward"><?php esc_html_e( 'View Cart', 'ocin' ); ?></a>
		<a href="<?php echo esc_url( wc_get_checkout_url() ); ?>" class="button checkout wc-forward"><?php esc_html_e( 'Checkout', 'ocin' ); ?></a>
	</p>
</div>
<?php endif; ?>
...
<ul class="cart_list product_list_widget owl-carousel products <?php echo $args['list_class']; ?>">
	...
	<?php else : ?>
		...
		<li class="empty"><?php esc_html_e( 'No products in the cart.', 'ocin' ); ?></li>
